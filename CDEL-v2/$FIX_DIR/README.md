...
```bash
ls -la CDEL-v2/$FIX_DIR
find CDEL-v2/$FIX_DIR -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/$FIX_DIR | sed -n '1,40p'
```
