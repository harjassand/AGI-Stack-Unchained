"""Suite-based harness implementation for sealed evaluation."""
...
HARNESS_ID = "suite-harness-v1"
HARNESS_HASH = "suite-harness-hash"
...
class SuiteHarness:
    ...
    def run_episodes(
        ...
        *,
        ...
        expected_arity = len(oracle_def.params)
        ...
        for episode in range(episodes):
            args_raw = rows[episode]
            if len(args_raw) != expected_arity:
                raise ValueError("suite args arity mismatch")
...
def _parse_suite_rows(suite_bytes: bytes) -> list[list[object]]:
