...
```bash
ls -la CDEL-v2/cdel/v11_0
find CDEL-v2/cdel/v11_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v11_0 | sed -n '1,40p'
```
