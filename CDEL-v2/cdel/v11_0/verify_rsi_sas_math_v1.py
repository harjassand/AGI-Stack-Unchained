"""Verifier for RSI SAS-MATH v11.0."""
...
def _verify_root_manifest(state_dir: Path) -> None:
    ...
    expected = canon_root_v1_for(str(manifest.get("agi_root_raw", "")), "rsi_sas_math_v11_0")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify RSI SAS-MATH v11.0")
