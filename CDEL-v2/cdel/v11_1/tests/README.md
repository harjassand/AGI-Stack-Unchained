...
```bash
ls -la CDEL-v2/cdel/v11_1/tests
find CDEL-v2/cdel/v11_1/tests -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v11_1/tests | sed -n '1,40p'
```
