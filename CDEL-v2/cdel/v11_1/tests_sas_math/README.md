...
> Path: `CDEL-v2/cdel/v11_1/tests_sas_math`
...
- `test_sas_math_conjecture_bundle_missing.py`: Python module or executable script.
- `test_sas_math_conjecture_not_in_bundle.py`: Python module or executable script.
- `test_sas_math_conjecture_statement_hash_mismatch.py`: Python module or executable script.
...
```bash
ls -la CDEL-v2/cdel/v11_1/tests_sas_math
find CDEL-v2/cdel/v11_1/tests_sas_math -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v11_1/tests_sas_math | sed -n '1,40p'
```
