...
def test_perf_policy_cannot_relax_threshold(tmp_path: Path) -> None:
    ...
    assert "INVALID:PERF_POLICY_FORBIDDEN_VALUE:min_improvement_percent" in str(exc.value)
