"""SAS-Science ledger helpers (v13.0)."""
...
SAS_SCIENCE_EVENT_TYPES = {
    "SAS_SCIENCE_BOOT",
    "SAS_SCIENCE_ROOT_MANIFEST_WRITTEN",
    "SAS_SCIENCE_ENABLE_PRESENT",
    "SAS_SCIENCE_DATASET_RECEIPT",
    "SAS_SCIENCE_SPLIT_RECEIPT",
    "SAS_SCIENCE_BASELINES_READY",
    "SAS_SCIENCE_CANDIDATE_BUNDLE_WRITTEN",
    "SAS_SCIENCE_FIT_DONE",
    "SAS_SCIENCE_EVAL_DEV_DONE",
    "SAS_SCIENCE_EVAL_HELDOUT_DONE",
    "SAS_SCIENCE_SELECTION_DONE",
    "SAS_SCIENCE_PROMOTION_WRITTEN",
    "SAS_SCIENCE_SHUTDOWN",
    "SAS_SCIENCE_FATAL",
}
...
__all__ = ["SAS_SCIENCE_EVENT_TYPES", "compute_entry_hash", "load_ledger", "validate_chain", "LedgerError"]
