...
from cdel.v15_1.verify_rsi_sas_kernel_v15_1 import (
    V15_1KernelError,
    _sealed_lean_replay,
...
def test_proof_replay_negative(tmp_path: Path) -> None:
    root = repo_root()
    ...
    proof.write_text(
        ...
        "  exact does_not_exist\n",
        encoding="utf-8",
    )

    with pytest.raises(V15_1KernelError):
        _sealed_lean_replay(lean_tool=lean_tool, proof_path=proof, state_dir=state_dir)
