"""Analysis-only Omega campaign for legacy efficiency/flywheel skill reports."""
...
_CAMPAIGN_ID = "rsi_omega_skill_eff_flywheel_v1"
_SCHEMA_VERSION = "rsi_omega_skill_eff_flywheel_pack_v1"
_ADAPTER_MODULE = "cdel.v18_0.skills.eff_flywheel_v2_0_adapter_v1"
_FIXED_REPORT_REL = Path("skills/reports/eff_flywheel/omega_skill_report_v1.json")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="campaign_omega_skill_eff_flywheel_v1")
