"""Analysis-only Omega campaign for legacy persistence skill reports."""
...
_CAMPAIGN_ID = "rsi_omega_skill_persistence_v1"
_SCHEMA_VERSION = "rsi_omega_skill_persistence_pack_v1"
_ADAPTER_MODULE = "cdel.v18_0.skills.persistence_v6_adapter_v1"
_FIXED_REPORT_REL = Path("skills/reports/persistence/omega_skill_report_v1.json")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="campaign_omega_skill_persistence_v1")
