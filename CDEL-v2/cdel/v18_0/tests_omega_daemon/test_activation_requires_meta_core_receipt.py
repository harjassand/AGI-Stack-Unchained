...
def test_activation_requires_meta_core_receipt(tmp_path) -> None:
    ...
    activation_payload = {
        ...
        "after_active_manifest_hash": "sha256:" + "2" * 64,
    ...
    snapshot["promotion_receipt_hash"] = None
    write_json(snapshot_path, snapshot)

    with pytest.raises(OmegaV18Error, match="ACTIVATION_REQUIRES_PROMOTION"):
