...
```bash
ls -la CDEL-v2/cdel/v1_5r
find CDEL-v2/cdel/v1_5r -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v1_5r | sed -n '1,40p'
```
