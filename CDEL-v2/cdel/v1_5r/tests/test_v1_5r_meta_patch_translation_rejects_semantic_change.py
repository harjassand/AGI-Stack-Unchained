...
def test_v1_5r_meta_patch_translation_rejects_semantic_change() -> None:
    ...
    assert overall.get("equiv_ok") is False
    fail_reasons = []
    ...
    assert "TRANSLATION_EQUIV_FAIL" in fail_reasons
