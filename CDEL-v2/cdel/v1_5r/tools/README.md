...
```bash
ls -la CDEL-v2/cdel/v1_5r/tools
find CDEL-v2/cdel/v1_5r/tools -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v1_5r/tools | sed -n '1,40p'
```
