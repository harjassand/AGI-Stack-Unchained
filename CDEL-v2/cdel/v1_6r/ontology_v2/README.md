...
> Path: `CDEL-v2/cdel/v1_6r/ontology_v2`
...
```bash
ls -la CDEL-v2/cdel/v1_6r/ontology_v2
find CDEL-v2/cdel/v1_6r/ontology_v2 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v1_6r/ontology_v2 | sed -n '1,40p'
```
