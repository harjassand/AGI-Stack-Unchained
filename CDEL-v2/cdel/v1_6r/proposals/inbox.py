"""Proposal inbox paths for v1.6r campaigns."""
...
INBOX_ONTOLOGY_V2_DIR = "current/inbox/ontology_v2"
...
def load_ontology_proposals(state_dir: Path) -> list[dict[str, Any]]:
    return _load_inbox_dir(state_dir / INBOX_ONTOLOGY_V2_DIR, "ontology_patch_v2")
