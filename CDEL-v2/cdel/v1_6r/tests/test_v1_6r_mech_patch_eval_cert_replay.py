...
def test_mech_patch_eval_cert_replay(tmp_path: Path) -> None:
    instance_pack = {
    ...
    base_mech = {
        "schema": "base_mech_v1",
        "schema_version": 1,
        "candidate_symbol": "policy_up",
        "baseline_symbol": "policy_up",
        "oracle_symbol": "policy_up",
        "definitions": [{"name": "policy_up", "body": {"tag": "int", "value": 0}}],
    }
    ...
    patch = {
        ...
        "policy_program": {"name": "policy_right_0", "body": {"tag": "int", "value": 3}},
        "bounds": {
    ...
    cert_a, _ = compute_mech_patch_eval_cert(
        epoch_id="epoch_1",
        patch=patch,
        base_mech=base_mech,
    ...
    cert_a["x-meta"] = meta_identities()

    cert_b, _ = compute_mech_patch_eval_cert(
        epoch_id="epoch_1",
        patch=patch,
        base_mech=base_mech,
        benchmark_pack=benchmark_pack,
    ...
    cert_b["x-meta"] = meta_identities()

    assert cert_a == cert_b
    assert cert_a["overall"]["pass"] is True
