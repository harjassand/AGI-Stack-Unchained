...
def test_witness_emission_on_invalid_suite_row(tmp_path: Path) -> None:
    ...
    fam_path = fam_dir / "invalid_suite.json"
    family = _write_family(fam_path, suite_row, "core-invalid-suite")
        ...
        "core_families": [
            {
                ...
                "path": "families/invalid_suite.json",
                "corridor_len": 4,
                "role": "core",
            }
        ],
    ...
    assert any(w.get("failure_mode") == "INVALID_SUITE_ROW" for w in witnesses)
