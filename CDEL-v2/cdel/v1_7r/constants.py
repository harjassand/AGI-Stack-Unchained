"""Constants + meta identities loader for v1.7r."""
...
from .canon import hash_json, load_canon_json, sha256_prefixed
...
def require_constants() -> dict[str, Any]:
    ...
    constants_path = meta_root / "meta_constitution" / "v1_7r" / "constants_v1.json"
...
def meta_identities() -> dict[str, str]:
    meta_root = _meta_core_root()
    meta_hash = _read_text(meta_root / "meta_constitution" / "v1_7r" / "META_HASH")
