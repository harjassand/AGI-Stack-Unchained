"""RSI demon v5 autonomy campaign runner."""
...
from ...v1_8r.metabolism_v1.translation import load_translation_inputs
from ...v1_8r.demon.tracker import write_receipt
from ..constants import require_constants as require_constants_v1_9r
...
def run_campaign(*, campaign_pack: Path, out_dir: Path, mode: str, strict: bool) -> None:
    ...
    if pack.get("schema") != "rsi_real_demon_campaign_pack_v5":
        raise CanonError("campaign_pack schema mismatch")
    if int(pack.get("schema_version", 0)) != 5:
    ...
    if metabolism_dir != "__AUTONOMY_RUNDIR_V1__":
    ...
    constants_meta = require_constants_v1_9r()
