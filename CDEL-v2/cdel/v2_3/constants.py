"""Constants + meta identities loader for v2.3."""
...
def require_constants() -> dict[str, Any]:
    ...
    constants_path = meta_root / "meta_constitution" / "v2_3" / "constants_v1.json"
...
def meta_identities() -> dict[str, str]:
    meta_root = _meta_core_root()
    meta_hash = _read_text(meta_root / "meta_constitution" / "v2_3" / "META_HASH")
