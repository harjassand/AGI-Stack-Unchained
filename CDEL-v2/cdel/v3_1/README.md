...
- `verify_rsi_swarm_v2.py`: Python module or executable script.
...
```bash
ls -la CDEL-v2/cdel/v3_1
find CDEL-v2/cdel/v3_1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v3_1 | sed -n '1,40p'
```
