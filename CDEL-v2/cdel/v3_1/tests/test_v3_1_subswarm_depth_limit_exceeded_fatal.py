...
def test_v3_1_subswarm_depth_limit_exceeded_fatal(tmp_path: Path, repo_root: Path) -> None:
    run = build_valid_swarm_run(tmp_path, repo_root, root_max_depth=1, child_depth=2)
