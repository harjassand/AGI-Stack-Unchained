...
- `verify_rsi_swarm_v3.py`: Python module or executable script.
...
```bash
ls -la CDEL-v2/cdel/v3_2
find CDEL-v2/cdel/v3_2 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/cdel/v3_2 | sed -n '1,40p'
```
