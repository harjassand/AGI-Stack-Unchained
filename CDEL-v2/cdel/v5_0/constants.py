"""Constants + meta identities loader for v5.0 thermo runs."""
...
def require_constants() -> dict[str, Any]:
    ...
    constants_path = meta_root / "meta_constitution" / "v5_0" / "constants_v1.json"
...
def meta_identities() -> dict[str, str]:
    meta_root = _meta_core_root()
    meta_hash = _read_text(meta_root / "meta_constitution" / "v5_0" / "META_HASH")
...
__all__ = ["meta_identities", "require_constants"]
