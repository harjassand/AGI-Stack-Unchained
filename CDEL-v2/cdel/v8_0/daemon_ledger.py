"""Daemon ledger parsing + hash chain validation (v8.0)."""
...
EVENT_TYPES = {
    ...
    "BOUNDLESS_MATH_POLICY_DENY",
    "BOUNDLESS_MATH_TOOLCHAIN_DRIFT",
    "BOUNDLESS_MATH_SEALED_RECEIPT_MISSING",
    "BOUNDLESS_MATH_ACCEPT_WITHOUT_PASS",
    "BOUNDLESS_MATH_BUDGET_EXCEEDED",
    "BOUNDLESS_MATH_FATAL_UNHANDLED",
}
