...
- `ccai_x_mind_v1_ext2/`: component subtree.
- `ccai_x_mind_v2/`: component subtree.
- `ccai_x_superproof_v1/`: component subtree.
...
```bash
ls -la CDEL-v2/proof
find CDEL-v2/proof -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files CDEL-v2/proof | sed -n '1,40p'
```
