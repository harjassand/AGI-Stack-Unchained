...
> Path: `Extension-1/CDEL/cdel/adoption`
...
```bash
ls -la Extension-1/CDEL/cdel/adoption
find Extension-1/CDEL/cdel/adoption -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Extension-1/CDEL/cdel/adoption | sed -n '1,40p'
```
