...
> Path: `Extension-1/CDEL/cdel/bench`
...
```bash
ls -la Extension-1/CDEL/cdel/bench
find Extension-1/CDEL/cdel/bench -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Extension-1/CDEL/cdel/bench | sed -n '1,40p'
```
