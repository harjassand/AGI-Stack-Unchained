...
> Path: `Extension-1/CDEL/experiments`
...
```bash
ls -la Extension-1/CDEL/experiments
find Extension-1/CDEL/experiments -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Extension-1/CDEL/experiments | sed -n '1,40p'
```
