...
> Path: `Extension-1/CDEL/incident_symbol_redef_20260120`
...
```bash
ls -la Extension-1/CDEL/incident_symbol_redef_20260120
find Extension-1/CDEL/incident_symbol_redef_20260120 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Extension-1/CDEL/incident_symbol_redef_20260120 | sed -n '1,40p'
```
