"""Memoryless policy oracle for regime solvability."""
...
def solve(
    *,
    ...
    if not found:
        notes = "No memoryless policy found within bound"

    payload = {
        "schema": "solve_regime_oracle_memoryless_v1",
        "regime_id": regime_id,
        "seed": int(seed),
        "horizon": int(horizon),
        "found": bool(found),
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Memoryless policy oracle for CAOE regimes.")
