...
from self_improve_code_v1.domains.flagship_code_rsi_v1.patch_templates_v1 import template_ids
...
def test_attempt_loop_produces_valid_patch_when_available(tmp_path: Path) -> None:
    ...
    config = {
        ...
        "proposal": {
            ...
            "explore_fraction": 0,
            "max_attempts_per_slot": len(template_ids()),
            "max_total_attempts": 100,
            "min_eligible_per_epoch": 1,
            "template_allowlist": [
                "fix_bool_condition_v1",
                "return_early_on_invalid_v1",
            ],
        },
