...
from ccai_x_v1.canonical_json import assert_no_floats  # noqa: E402
...
from ccai_x_v1.validate_instance import load_json_strict, validate_path  # noqa: E402
...
class TestCcaiXV1Vectors(unittest.TestCase):
    ...
    def test_hashes(self) -> None:
        ...
        workspace_state = load_json(VEC_DIR / "workspace_state.json")
        expected_workspace_state_hash = read_expected("expected_workspace_state_hash.txt")
        computed_state_hash = workspace_state_hash(
            workspace_state["prev_state_hash"], workspace_state["beliefs"]
        )
        self.assertEqual(computed_state_hash, expected_workspace_state_hash)
        self.assertEqual(workspace_state["state_hash"], expected_workspace_state_hash)
        ...
        candidate_id = candidate_id_from_tar(str(VEC_DIR / "ccai_x_mind_patch_candidate_v1.tar"))
