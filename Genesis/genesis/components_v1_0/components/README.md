...
> Path: `Genesis/genesis/components_v1_0/components`
...
- `a69950e4988df601836c161fb17bee610fdda7be593ce53537395f2c4420dc48.json`: JSON contract, config, or artifact.
- `aac113122237bf8e26863800e021b12710d929779f95f9120a65befbd20b857e.json`: JSON contract, config, or artifact.
- `ada418601a2ce30e206c7ddf4b2e50ff45490a3b051c7821a19512d74aebb956.json`: JSON contract, config, or artifact.
- `b42dc2e1b6af1f6912536a464b96c66ec811e41ff74aaa2daa2d6cbf9420767e.json`: JSON contract, config, or artifact.
- `b8f71a28ad518a493bd838ecfebd7a29b1662b3f29a2c5efbc83c6991e2bf4dc.json`: JSON contract, config, or artifact.
- ... and 12 more files.
...
```bash
ls -la Genesis/genesis/components_v1_0/components
find Genesis/genesis/components_v1_0/components -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/genesis/components_v1_0/components | sed -n '1,40p'
```
