...
> Path: `Genesis/genesis/components_v1_1/components`
...
```bash
ls -la Genesis/genesis/components_v1_1/components
find Genesis/genesis/components_v1_1/components -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/genesis/components_v1_1/components | sed -n '1,40p'
```
