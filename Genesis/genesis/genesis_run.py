...
from genesis.core.search_loop import run_search, SearchEvent  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Genesis end-to-end run")
    ...
    if cdel_root:
        os.environ["GENESIS_CDEL_ROOT"] = cdel_root
    ...
    events: list[SearchEvent] = results["events"]
    ...
    margin = calibrator.margin_for_epoch(epoch_id)
