...
from genesis.core.world_model_search import run_world_model_search, WorldModelEvent  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Genesis world model run")
    ...
    results = run_world_model_search(config)
    events: list[WorldModelEvent] = results["events"]
