...
```bash
ls -la Genesis/schema/ccai_x_v1
find Genesis/schema/ccai_x_v1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/schema/ccai_x_v1 | sed -n '1,40p'
```
