...
- `sas_math_lease_token_v1.jsonschema`: JSON Schema contract.
- `sas_math_policy_allowlist_v1.jsonschema`: JSON Schema contract.
- `sas_math_policy_fingerprint_v1.jsonschema`: JSON Schema contract.
- `sas_math_policy_ir_v1.jsonschema`: JSON Schema contract.
- `sas_math_promotion_bundle_v1.jsonschema`: JSON Schema contract.
- ... and 13 more files.
...
```bash
ls -la Genesis/schema/v11_0
find Genesis/schema/v11_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/schema/v11_0 | sed -n '1,40p'
```
