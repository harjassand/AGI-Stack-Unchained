...
```bash
ls -la Genesis/schema/v11_1
find Genesis/schema/v11_1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/schema/v11_1 | sed -n '1,40p'
```
