...
```bash
ls -la Genesis/schema/v16_0
find Genesis/schema/v16_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/schema/v16_0 | sed -n '1,40p'
```
