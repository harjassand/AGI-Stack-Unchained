...
- `dmpl_dataset_chunk_v1.jsonschema`: JSON Schema contract.
- `dmpl_dataset_pack_v1.jsonschema`: JSON Schema contract.
- `dmpl_droot_v1.jsonschema`: JSON Schema contract.
- ... and 145 more files.

## File-Type Surface

- `jsonschema`: 169 files
- `schema`: 1 files

## Operational Checks

```bash
ls -la Genesis/schema/v18_0
find Genesis/schema/v18_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files Genesis/schema/v18_0 | sed -n '1,40p'
```
