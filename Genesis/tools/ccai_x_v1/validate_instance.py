...
SCHEMA_DIR = ROOT / "schema" / "ccai_x_v1"
...
SCHEMAS = {
    ...
    "ccai_x_mind_patch_candidate_manifest_v1": SCHEMA_DIR
...
def _check_sorted(obj: dict) -> None:
    ...
    elif fmt == "ccai_x_mind_patch_candidate_manifest_v1":
...
def validate_jsonl_file(path: Path) -> None:
    ...
    for idx, line in enumerate(lines[:-1]):
        ...
        if obj.get("format") != "intervention_log_entry_v1":
