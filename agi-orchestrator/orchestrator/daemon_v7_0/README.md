...
> Path: `agi-orchestrator/orchestrator/daemon_v7_0`
...
```bash
ls -la agi-orchestrator/orchestrator/daemon_v7_0
find agi-orchestrator/orchestrator/daemon_v7_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files agi-orchestrator/orchestrator/daemon_v7_0 | sed -n '1,40p'
```
