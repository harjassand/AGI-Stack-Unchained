...
> Path: `agi-orchestrator/orchestrator/daemon_v8_0_math`
...
```bash
ls -la agi-orchestrator/orchestrator/daemon_v8_0_math
find agi-orchestrator/orchestrator/daemon_v8_0_math -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files agi-orchestrator/orchestrator/daemon_v8_0_math | sed -n '1,40p'
```
