"""Deterministic tick engine for daemon v8.0."""
...
class BudgetCounters:
    ...
    def from_dict(cls, payload: dict[str, Any] | None) -> "BudgetCounters":
        ...
        return cls(
            ...
            math_attempts_today=int(payload.get("math_attempts_today", 0)),
        )
...
class TickEngine:
    ...
    def record_math_attempt(self) -> None:
        self.counters.math_attempts_today += 1
