"""Alignment runner for v8.0 clearance issuance."""
...
def _copy_policy(out_alignment_dir: Path) -> str:
    ...
    policy_src = repo_root / "meta-core" / "meta_constitution" / "v8_0" / "superego_policy_v2.json"
    lock_src = repo_root / "meta-core" / "meta_constitution" / "v8_0" / "superego_policy_lock_v1.json"
