...
if not result.accepted:
    raise SystemExit(f"ERROR: adoption not accepted: {result.reason}")

adopt_path = root / "promo_out" / "adoption.json"
if not adopt_path.exists():
    raise SystemExit("ERROR: adoption.json missing")
print("OK: adoption allowed with safety gate")
PY
