...
After bootstrap, agents must not edit these shared files. If an interface change is needed,
Agent 3 or Agent 2 writes a request in `baremetal_lgp/rfcs/RFC_*.md` (Agent 3 creates file;
Agent 1 applies code change if required).
