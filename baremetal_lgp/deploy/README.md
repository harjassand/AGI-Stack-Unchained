...
```bash
ls -la baremetal_lgp/deploy
find baremetal_lgp/deploy -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files baremetal_lgp/deploy | sed -n '1,40p'
```
