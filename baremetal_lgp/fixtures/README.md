...
```bash
ls -la baremetal_lgp/fixtures
find baremetal_lgp/fixtures -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files baremetal_lgp/fixtures | sed -n '1,40p'
```
