...
pub const MAX_SEARCHLAW_PUBLIC_CANDIDATES: usize = 6;
pub const MAX_SEARCHLAW_AB_CANDIDATES: usize = 2;
pub const MAX_SEARCHLAW_AB_BRANCHES_PER_SIDE: usize = 4;
pub const MAX_PORTFOLIO_BRANCHES: usize = 8;
pub const MAX_BRANCH_LOCAL_DEBT_CREDITS: i32 = 3;
pub const MAX_GLOBAL_DEBT_CREDITS: i32 = 8;
pub const MAX_IDLE_EPOCHS_BEFORE_CULL: u32 = 3;
pub const MAX_HIDDEN_CHALLENGE_FAMILIES: usize = 4;
pub const MAX_CHALLENGE_WINDOWS_PER_FAMILY: usize = 256;
pub const CHALLENGE_RETIRE_AFTER_EPOCHS: u64 = 8;
pub const HOLDOUT_RETIRE_AFTER_EPOCHS: u64 = 12;
pub const MAX_NEEDTOKENS_PER_EPOCH: usize = 8;
pub const MAX_QD_CELLS: usize = 128;
pub const MAX_RECOMBINATION_PARENTS: usize = 2;
pub const MAX_LAWTOKENS_PER_EPOCH: usize = 128;
pub const MAX_LAWARCHIVE_IN_MEMORY_RECORDS: usize = 50_000;
pub const SEARCHLAW_MIN_AB_EPOCHS: u32 = 2;
pub const SEARCHLAW_MAX_AB_EPOCHS: u32 = 4;
pub const SEARCHLAW_REQUIRED_YIELD_IMPROVEMENT: f64 = 0.20;
pub const SEARCHLAW_MAX_SAFETY_REGRESSION: f64 = 0.0;
