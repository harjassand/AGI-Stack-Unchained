...
> Path: `campaigns/rsi_omega_daemon_v18_0`
...
```bash
ls -la campaigns/rsi_omega_daemon_v18_0
find campaigns/rsi_omega_daemon_v18_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v18_0 | sed -n '1,40p'
```
