...
> Path: `campaigns/rsi_omega_daemon_v18_0_prod`
...
```bash
ls -la campaigns/rsi_omega_daemon_v18_0_prod
find campaigns/rsi_omega_daemon_v18_0_prod -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v18_0_prod | sed -n '1,40p'
```
