...
> Path: `campaigns/rsi_omega_daemon_v19_0_llm_enabled`
...
```bash
ls -la campaigns/rsi_omega_daemon_v19_0_llm_enabled
find campaigns/rsi_omega_daemon_v19_0_llm_enabled -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v19_0_llm_enabled | sed -n '1,40p'
```
