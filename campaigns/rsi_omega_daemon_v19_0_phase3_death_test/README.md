...
> Path: `campaigns/rsi_omega_daemon_v19_0_phase3_death_test`
...
```bash
ls -la campaigns/rsi_omega_daemon_v19_0_phase3_death_test
find campaigns/rsi_omega_daemon_v19_0_phase3_death_test -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v19_0_phase3_death_test | sed -n '1,40p'
```
