...
> Path: `campaigns/rsi_omega_daemon_v19_0_phase3_market_mutator`
...
```bash
ls -la campaigns/rsi_omega_daemon_v19_0_phase3_market_mutator
find campaigns/rsi_omega_daemon_v19_0_phase3_market_mutator -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v19_0_phase3_market_mutator | sed -n '1,40p'
```
