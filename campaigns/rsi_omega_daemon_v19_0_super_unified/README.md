...
> Path: `campaigns/rsi_omega_daemon_v19_0_super_unified`
...
```bash
ls -la campaigns/rsi_omega_daemon_v19_0_super_unified
find campaigns/rsi_omega_daemon_v19_0_super_unified -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v19_0_super_unified | sed -n '1,40p'
```
