# rsi_omega_daemon_v19_0_superintelligence_demo_v1

> Path: `campaigns/rsi_omega_daemon_v19_0_superintelligence_demo_v1`
...
- `SIDC_V1_RUNBOOK.md`: documentation artifact.
...
- `orch_bandit_config_v1.json`: JSON contract, config, or artifact.
- `orch_policy_eval_config_v1.json`: JSON contract, config, or artifact.
...
```bash
ls -la campaigns/rsi_omega_daemon_v19_0_superintelligence_demo_v1
find campaigns/rsi_omega_daemon_v19_0_superintelligence_demo_v1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_omega_daemon_v19_0_superintelligence_demo_v1 | sed -n '1,40p'
```
