# rsi_proposer_arena_v1

> Path: `campaigns/rsi_proposer_arena_v1`
...
```bash
ls -la campaigns/rsi_proposer_arena_v1
find campaigns/rsi_proposer_arena_v1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_proposer_arena_v1 | sed -n '1,40p'
```
