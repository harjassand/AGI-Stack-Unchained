...
> Path: `campaigns/rsi_real_swarm_v3_1/inputs`
...
```bash
ls -la campaigns/rsi_real_swarm_v3_1/inputs
find campaigns/rsi_real_swarm_v3_1/inputs -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_real_swarm_v3_1/inputs | sed -n '1,40p'
```
