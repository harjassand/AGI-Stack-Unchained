...
> Path: `campaigns/rsi_sas_math_v11_0`
...
```bash
ls -la campaigns/rsi_sas_math_v11_0
find campaigns/rsi_sas_math_v11_0 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_0 | sed -n '1,40p'
```
