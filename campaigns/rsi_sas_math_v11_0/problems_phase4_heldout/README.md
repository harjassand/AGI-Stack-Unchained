...
> Path: `campaigns/rsi_sas_math_v11_0/problems_phase4_heldout`
...
```bash
ls -la campaigns/rsi_sas_math_v11_0/problems_phase4_heldout
find campaigns/rsi_sas_math_v11_0/problems_phase4_heldout -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_0/problems_phase4_heldout | sed -n '1,40p'
```
