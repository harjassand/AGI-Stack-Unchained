...
> Path: `campaigns/rsi_sas_math_v11_1/problems`
...
- `66472ebc08e563e5b977f60d9838fdfd449dd1ae7cffb1b52665a500dc44a91c.math_problem_spec_v1.json`: JSON contract, config, or artifact.
...
- `e0b9d4f045310f5ce7fae0546286e8b97d0c6256f8129ce60162932e84930f3e.math_problem_spec_v1.json`: JSON contract, config, or artifact.
- `sha256_66472ebc08e563e5b977f60d9838fdfd449dd1ae7cffb1b52665a500dc44a91c.statement.txt`: text output or trace artifact.
...
- `sha256_e0b9d4f045310f5ce7fae0546286e8b97d0c6256f8129ce60162932e84930f3e.statement.txt`: text output or trace artifact.
...
```bash
ls -la campaigns/rsi_sas_math_v11_1/problems
find campaigns/rsi_sas_math_v11_1/problems -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_1/problems | sed -n '1,40p'
```
