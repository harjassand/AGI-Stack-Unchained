...
> Path: `campaigns/rsi_sas_math_v11_2`
...
```bash
ls -la campaigns/rsi_sas_math_v11_2
find campaigns/rsi_sas_math_v11_2 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_2 | sed -n '1,40p'
```
