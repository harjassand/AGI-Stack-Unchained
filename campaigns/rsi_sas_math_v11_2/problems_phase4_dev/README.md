...
> Path: `campaigns/rsi_sas_math_v11_2/problems_phase4_dev`
...
```bash
ls -la campaigns/rsi_sas_math_v11_2/problems_phase4_dev
find campaigns/rsi_sas_math_v11_2/problems_phase4_dev -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_2/problems_phase4_dev | sed -n '1,40p'
```
