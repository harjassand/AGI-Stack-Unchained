...
> Path: `campaigns/rsi_sas_math_v11_3`
...
- `conjecture_preamble_v11_3.lean`: project artifact.
...
- `rsi_sas_math_pack_v11_3.json`: JSON contract, config, or artifact.
- `sas_conjecture_gen_config_v1.json`: JSON contract, config, or artifact.
- `sas_conjecture_gen_config_v2.json`: JSON contract, config, or artifact.
- `sas_conjecture_gen_config_v3.json`: JSON contract, config, or artifact.
- `sas_conjecture_selection_policy_v1.json`: JSON contract, config, or artifact.
- `sas_conjecture_selection_policy_v2.json`: JSON contract, config, or artifact.
- `sas_conjecture_selection_policy_v3.json`: JSON contract, config, or artifact.
- `sas_math_forbidden_proof_tokens_v1.json`: JSON contract, config, or artifact.
...
- `sas_math_policy_allowlist_v2.json`: JSON contract, config, or artifact.
...
```bash
ls -la campaigns/rsi_sas_math_v11_3
find campaigns/rsi_sas_math_v11_3 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_3 | sed -n '1,40p'
```
