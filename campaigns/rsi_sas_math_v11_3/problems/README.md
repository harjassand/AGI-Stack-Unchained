...
> Path: `campaigns/rsi_sas_math_v11_3/problems`
...
```bash
ls -la campaigns/rsi_sas_math_v11_3/problems
find campaigns/rsi_sas_math_v11_3/problems -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_math_v11_3/problems | sed -n '1,40p'
```
