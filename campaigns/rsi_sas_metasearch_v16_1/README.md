...
> Path: `campaigns/rsi_sas_metasearch_v16_1`
...
- `rsi_sas_metasearch_pack_v16_1.json`: JSON contract, config, or artifact.
...
```bash
ls -la campaigns/rsi_sas_metasearch_v16_1
find campaigns/rsi_sas_metasearch_v16_1 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files campaigns/rsi_sas_metasearch_v16_1 | sed -n '1,40p'
```
