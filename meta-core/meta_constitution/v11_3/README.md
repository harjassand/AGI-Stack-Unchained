...
> Path: `meta-core/meta_constitution/v11_3`
...
```bash
ls -la meta-core/meta_constitution/v11_3
find meta-core/meta_constitution/v11_3 -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files meta-core/meta_constitution/v11_3 | sed -n '1,40p'
```
