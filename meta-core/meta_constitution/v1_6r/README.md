...
> Path: `meta-core/meta_constitution/v1_6r`
...
- `ontology_contract_v2.md`: documentation artifact.
...
```bash
ls -la meta-core/meta_constitution/v1_6r
find meta-core/meta_constitution/v1_6r -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files meta-core/meta_constitution/v1_6r | sed -n '1,40p'
```
