#!/usr/bin/env python3
"""Deterministically regenerate immutable_core_lock_v1.json for meta_constitution/v5_0.
...
OUT_PATH = REPO_ROOT / "meta-core" / "meta_constitution" / "v5_0" / "immutable_core_lock_v1.json"

DEFAULT_SOURCE_ROOTS = [
    "meta-core/kernel/verifier/",
    "meta-core/meta_constitution/v5_0/",
    "Genesis/schema/v5_0/",
    "CDEL-v2/cdel/v5_0/",
    "CDEL-v2/cdel/v1_7r/",
    "CDEL-v2/cdel/v2_3/",
    "Extension-1/agi-orchestrator/orchestrator/thermo_v5_0/",
    "Extension-1/agi-orchestrator/orchestrator/rsi_thermo_v5_0.py",
]
