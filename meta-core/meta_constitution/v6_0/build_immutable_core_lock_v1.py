#!/usr/bin/env python3
"""Deterministically regenerate immutable_core_lock_v1.json for meta_constitution/v6_0.

This follows the v4.0 local stand-in lock builder pattern: scan fixed source roots,
apply an exclude list, and write a v2_3 immutable-core lock file.

The lock excludes itself and META_HASH to avoid self-referential hashing.
"""
...
OUT_PATH = REPO_ROOT / "meta-core" / "meta_constitution" / "v6_0" / "immutable_core_lock_v1.json"

DEFAULT_SOURCE_ROOTS = [
    "meta-core/kernel/verifier/",
    "meta-core/meta_constitution/v6_0/",
    "Genesis/schema/v6_0/",
    "CDEL-v2/cdel/v6_0/",
    "CDEL-v2/cdel/v1_7r/",
    "CDEL-v2/cdel/v2_3/",
    "Extension-1/agi-orchestrator/orchestrator/daemon_v6_0/",
    "Extension-1/agi-orchestrator/orchestrator/rsi_daemon_v6_0.py",
]
