...
```bash
ls -la meta-core/stage/bundles
find meta-core/stage/bundles -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files meta-core/stage/bundles | sed -n '1,40p'
```
