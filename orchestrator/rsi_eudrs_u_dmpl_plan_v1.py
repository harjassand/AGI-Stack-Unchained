"""Omega-dispatchable EUDRS-U bootstrap producer: dmpl_plan v1."""
...
# Allow running as a script: `python orchestrator/rsi_eudrs_u_dmpl_plan_v1.py ...`.
...
_CAMPAIGN_ID = "rsi_eudrs_u_dmpl_plan_v1"
_PACK_SCHEMA = "rsi_eudrs_u_dmpl_plan_pack_v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    emit_eudrs_u_bootstrap_promotion_bundle_v1(state_dir=state_dir, producer_kind="dmpl_plan")
