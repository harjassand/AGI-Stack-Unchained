"""Omega-dispatchable EUDRS-U producer: eval_cac v1 (DMPL Phase 4).

This producer emits a self-contained promotion bundle including DMPL training
evidence and Phase-4 certificates. RE2 recomputes deterministically and gates
...
# Allow running as a script: `python orchestrator/rsi_eudrs_u_eval_cac_v1.py ...`.
...
_CAMPAIGN_ID = "rsi_eudrs_u_eval_cac_v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    emit_dmpl_phase4_promotion_bundle_v1(state_dir=state_dir, producer_kind="eval_cac")
