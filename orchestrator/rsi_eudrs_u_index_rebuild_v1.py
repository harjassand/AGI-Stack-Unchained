"""Omega-dispatchable EUDRS-U producer: index_rebuild v1 (DMPL Phase 4).

This producer emits a DMPL-enabled staged registry tree and promotion summary
that include:
  - root tuple with droot (dmpl_droot_v1)
  - dmpl_evidence (plan + train + certificates)

RE2 promotion verifier recomputes deterministically and fails closed.
"""
...
# Allow running as a script: `python orchestrator/rsi_eudrs_u_index_rebuild_v1.py ...`.
...
_CAMPAIGN_ID = "rsi_eudrs_u_index_rebuild_v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    emit_dmpl_phase4_promotion_bundle_v1(state_dir=state_dir, producer_kind="index_rebuild")
