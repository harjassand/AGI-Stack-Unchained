"""Omega-dispatchable EUDRS-U producer: ontology_update v1 (DMPL Phase 4).

This producer emits a DMPL-enabled promotion bundle (including training replay
evidence and Phase-4 certificates). Ontology artifacts themselves are stubbed
in this checkout; RE2 verification is authoritative.
"""
...
# Allow running as a script: `python orchestrator/rsi_eudrs_u_ontology_update_v1.py ...`.
...
_CAMPAIGN_ID = "rsi_eudrs_u_ontology_update_v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    emit_dmpl_phase4_promotion_bundle_v1(state_dir=state_dir, producer_kind="ontology_update")
