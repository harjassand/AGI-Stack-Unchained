"""Root manifest writer for SAS-Science (v13.0)."""
    ...
    manifest.update(
        {
            ...
            "agi_root_canon_hash": sha256_prefixed(str(canon.get("agi_root_canon", "")).encode("utf-8")),
            "sas_root_canon_hash": sha256_prefixed(str(canon.get("sas_root_canon", "")).encode("utf-8")),
        }
    )
