...
- `blobs/`: component subtree.
- `indexes/`: component subtree.
...
```bash
ls -la polymath/store
find polymath/store -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files polymath/store | sed -n '1,40p'
```
