...
```bash
ls -la polymath/store/blobs
find polymath/store/blobs -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files polymath/store/blobs | sed -n '1,40p'
```
