...
echo "Tick 1 dispatch dir: ${ROOT}/runs/${RUN_ID}/tick_0001/daemon/rsi_omega_daemon_v19_0/state/dispatch"
echo "Tick 2 native stats: ${ROOT}/runs/${RUN_ID}/tick_0002/daemon/rsi_omega_daemon_v19_0/state/ledger/native"
