...
> Path: `smoking_gun_v11_0_2026-02-04/state/alignment`
...
```bash
ls -la smoking_gun_v11_0_2026-02-04/state/alignment
find smoking_gun_v11_0_2026-02-04/state/alignment -mindepth 1 -maxdepth 2 -type d | sed -n '1,40p'
rg --files smoking_gun_v11_0_2026-02-04/state/alignment | sed -n '1,40p'
```
